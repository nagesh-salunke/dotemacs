...
*** Org Files
 ...
 | people        | ~/personal/org/people.org     | Contact               |                                                     |
	    ...
	    "* %?\n\n%^T\n\n:PROPERTIES:\n\n:END:\n\n")
	     ...
	     ("i" "Interrupting task" entry
	      ...
	      Expenses:%^{Account}  %^{Amount}")
	       ...
	       ("C" "Contact" entry (file "~/personal/org/contacts.org")
...
I like looking at 4 days at a time when I plan using the Org agenda.
