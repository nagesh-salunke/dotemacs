...
*** Dired
*** helm-swoop - easy search in buff
...
#+BEGIN_SRC emacs-lisp-not-not-enabled
...
(use-package elfeed-org
  :config
  (elfeed-org)
  (setq rmh-elfeed-org-files (list "~/.emacs.d/blogs.org")))
...
*** Org Files
 ...
 | work-1.org    | ~/personal/org/amazon.org     | Team                  | Work Items Project, on call meetings                |
...
(when (require 'multi-term nil t)
  (global-set-key (kbd "<alt-return>") 'multi-term)
